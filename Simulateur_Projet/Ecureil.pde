...
======================================================================================================================================================================================================*/
  ...
  final private String MAP_PATH = "ressources/map animaux/map_Ecureil.png";             //Chemin vers la carte de présence de renard sur la terre
  final private PImage ICONE = icone_Ecureil;                                           //ID de la PImage de l'icone de slection
  ...
  final private int CONCENTRATION_MIN = 50;                                             //Concentration minimale de l'animal au km²
  final private int CONCENTRATION_MAX = 150;                                             //Concentration maximale de l'animal au km²
  final private int SANTE = 30;                                                        //Résistance à l'habitat
  final private int ENFANT_MIN = 1;                                                    //Nombre minimale d'enfants par portée
  final private int ENFANT_MAX = 8;                                                    //Nombre maximal d'enfants pas portée
  ...
  final private String DEFINE_NOM_ESPECE = "écureil";                                   //Nom de l'espèce
...
//------------------------------------------------------------------------------------------------FONCTION----------------------------------------------------------------------------------------------
  ...
  private void Breed(int x,int y){                                                           //algorythme de reproduction
      if((mois == 1 || mois == 2 || mois == 3) && jour == 1)
