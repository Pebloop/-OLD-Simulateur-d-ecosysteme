...
======================================================================================================================================================================================================*/
  ...
  final private String MAP_PATH = "ressources/map animaux/map_Hibou.png";             //Chemin vers la carte de présence de renard sur la terre
  final private PImage ICONE = icone_Hibou;                                           //ID de la PImage de l'icone de slection
  final private int[] BIOME_ADAPT = {4,0,1,0,0,-1,4,2,4,3,-30};                        //Tableau des valeurs de l'adaptation aux biome [0-10]
  final private String[] PREY_LIST = {"Renard", "Ecureil", "grenouile"};                                               //Liste des proies de l'espèce
  ...
  final private int ENFANT_MIN = 2;                                                    //Nombre minimale d'enfants par portée
  final private int ENFANT_MAX = 4;                                                    //Nombre maximal d'enfants pas portée
  
  final private int DEFINE_VITESSE_PROPAGATION = 1;                                    //vitesse de propagation en pourcentage lors de la migration mensuelle
  final private int DEFINE_DUREE_VIE = 25;                                              //Durée de vie en année maximale
  final private int DEFINE_VIEILLESSE_MIN = 20;                                         //Durée de vie minimale
  final private String DEFINE_NOM_ESPECE = "Hibou";                                   //Nom de l'espèce
