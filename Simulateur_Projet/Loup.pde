...
======================================================================================================================================================================================================*/
  ...
  final private String MAP_PATH = "ressources/map animaux/map_Loup.png";             //Chemin vers la carte de présence de renard sur la terre
  final private PImage ICONE = icone_Loup;                                           //ID de la PImage de l'icone de slection
  final private int[] BIOME_ADAPT = {4,0,1,0,0,-1,4,2,4,3,-30};                        //Tableau des valeurs de l'adaptation aux biome [0-10]
  final private String[] PREY_LIST = {"lapin", "renard", "caille","ecureil","grenouille"};                                               //Liste des proies de l'espèce
  ...
  final private int ENFANT_MIN = 5;                                                    //Nombre minimale d'enfants par portée
  ...
  final private String DEFINE_NOM_ESPECE = "Loup";                                   //Nom de l'espèce
...
//------------------------------------------------------------------------------------------------FONCTION----------------------------------------------------------------------------------------------
  ...
  private void Breed(int x,int y){                                                           //algorythme de reproduction
      if((mois == 3 || mois == 1 || mois == 2) && jour == 1)
