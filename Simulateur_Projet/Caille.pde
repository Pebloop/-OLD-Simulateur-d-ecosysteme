...
======================================================================================================================================================================================================*/
  ...
  final private String MAP_PATH = "ressources/map animaux/map_Caille.png";             //Chemin vers la carte de présence de renard sur la terre
  final private PImage ICONE = icone_Caille;                                           //ID de la PImage de l'icone de slection
  ...
  final private int DEFINE_DUREE_VIE = 5;                                              //Durée de vie en année maximale
  final private int DEFINE_VIEILLESSE_MIN = 3;                                         //Durée de vie minimale
  final private String DEFINE_NOM_ESPECE = "Caille";                                   //Nom de l'espèce
...
//------------------------------------------------------------------------------------------------FONCTION----------------------------------------------------------------------------------------------
  ...
  private void Breed(int x,int y){                                                           //algorythme de reproduction
      if((mois == 4 || mois == 5 || mois == 6) && jour == 1)
